...
for kappa_ind = 1:kappa_no
    ...
    [Adata.A,Adata.Q,Adata.R,nv,Adata.Rs] = genAdata(m,n,kappa,'QR',...
        [],seed,ir_parameters);
    
     % loop for different rhs
     for noise_ind = 1:noise_no
           ...
           % r = Adata.b - Adata.A*x;
            ...
            if converged
                ...
                results(1) = lsir_augmented(Adata,ir_parameters,...
                   'QR',[],results(1),kappa_ind,noise_ind,x,[]);
                
                
                 results(2) = lsir_LS(Adata,ir_parameters,...
                     'QR',[],results(2),kappa_ind,noise_ind,x,r,[]);
                
                results(3) = lsir_seminormal(Adata,ir_parameters,...
                     results(3),kappa_ind,noise_ind,x,r);
            end
...
plot_results(results(1),xvalues,yvalues,false)
plot_results(results(2),xvalues,yvalues,false)
plot_results(results(3),xvalues,yvalues,false)
...
for kappa_ind = 1:kappa_no
    ...
    [Adatas.A,Adatas.Q,Adatas.R,nvs,Adatas.Rs] = genAdata(m,n,kappa,'QR',...
        [],seed,ir_parameters);
     ...
     for noise_ind = 1:noise_no
            ...
            x = Adatas.R\(Adatas.Q(:,1:n)'*Adatas.b);
           ...
           % r = Adata.b - Adata.A*x;
            ...
            if converged
                ...
                results_us(1) = lsir_augmented(Adatas,ir_parameters,...
                   'QR',[],results_us(1),kappa_ind,noise_ind,x,[]);
                
                
                 results_us(2) = lsir_LS(Adatas,ir_parameters,...
                     'QR',[],results_us(2),kappa_ind,noise_ind,x,r,[]);
                
                results_us(3) = lsir_seminormal(Adatas,ir_parameters,...
                     results_us(3),kappa_ind,noise_ind,x,r);
            end
...
plot_results(results_us(1),xvalues,yvalues,false)
plot_results(results_us(2),xvalues,yvalues,false)
plot_results(results_us(3),xvalues,yvalues,false)

% plot x convergence
plot_xconverg(results_us,3,1,true,{'augmented','LS','semi-normal'})
plot_xconverg(results_us,7,1,false,[])
plot_xconverg(results_us,3,8,false,[])
plot_xconverg(results_us,7,8,false,[])

% plot r convergence
plot_rconverg(results_us,3,1,true,{'augmented','LS','semi-normal'})
plot_rconverg(results_us,7,1,false,[])
plot_rconverg(results_us,3,8,false,[])
plot_rconverg(results_us,7,8,false,[])
